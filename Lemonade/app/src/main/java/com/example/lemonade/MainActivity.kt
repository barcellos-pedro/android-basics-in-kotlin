    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                imagePath = R.drawable.lemon_tree
            }
            SQUEEZE -> {
                text = getString(R.string.lemon_squeeze)
                imagePath = R.drawable.lemon_squeeze
            }
            DRINK -> {
                text = getString(R.string.lemon_drink)
                imagePath = R.drawable.lemon_drink
            }
            RESTART -> {
                text = getString(R.string.lemon_empty_glass)
                imagePath = R.drawable.lemon_restart
            }
        }

        textAction.text = text
        lemonImage = findViewById(R.id.image_lemon_state)
        lemonImage!!.setImageResource(imagePath)
    }
